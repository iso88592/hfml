...
splicestrtest: src/splicestr.h src/splicestr.c src/splicestrtest.c src/hfml_lexer.c
	g++ -O3 -o splicestrtest src/splicestr.c src/splicestrtest.c src/hfml_lexer.c
